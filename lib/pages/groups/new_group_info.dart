      ...
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.of(context)!
              .translate('newGroupInfo', 'groupInfoString'),
        ...
        children: [
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: AppLocalizations.of(context)!
                    .translate('newGroupInfo', 'addGroupName'),
                hintStyle: TextStyle(
                  fontSize: 18.0,
                ),
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: AppLocalizations.of(context)!
                    .translate('newGroupInfo', 'addDescriptionString'),
                hintStyle: TextStyle(
                  fontSize: 18.0,
                ),
                ...
                Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        AppLocalizations.of(context)!
                            .translate('newGroupInfo', 'chooseOptionString'),
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 16.0,
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              AppLocalizations.of(context)!
                                  .translate('newGroupInfo', 'cameraString'),
                              style: TextStyle(
                          ...
                          children: [
                            ...
                            Text(
                              AppLocalizations.of(context)!.translate(
                                  'newGroupInfo', 'chooseFromGalleryString'),
                              style: TextStyle(
                                  color: Colors.black, fontSize: 16.0),
                            ),
                          ],
