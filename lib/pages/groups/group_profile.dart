...
import 'package:mesh_msgr/widget/column_builder.dart';
...
class _GroupProfileState extends State<GroupProfile> {
  ...
  Widget build(BuildContext context) {
    List<String> choices = <String>[
      AppLocalizations.of(context)!.translate('groupProfile', 'editString'),
      AppLocalizations.of(context)!.translate('groupProfile', 'reportString'),
      AppLocalizations.of(context)!.translate('groupProfile', 'exitGroupString')
    ];
  ...
  participants() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            '5 ${AppLocalizations.of(context)!.translate('groupProfile', 'participantsString')}',
          ...
          onTap: () {
            Fluttertoast.showToast(
              msg: AppLocalizations.of(context)!
                  .translate('groupProfile', 'reportString'),
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!
                      .translate('groupProfile', 'reportGroupString'),
                  style: msgTextStyle,
                ),
              ],
            ),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!
                      .translate('groupProfile', 'exitGroupString'),
                  style: msgTextStyle,
                ),
              ],
            ),
  ...
  void choiceAction(String choice) {
    if (choice ==
      ...
      Fluttertoast.showToast(
        msg: AppLocalizations.of(context)!
            .translate('groupProfile', 'editString'),
        backgroundColor: Colors.black,
        textColor: whiteColor,
      );
    } else if (choice ==
