...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    List<String> choices = <String>[
      AppLocalizations.of(context)!.translate('profile', 'reportString'),
          ...
          Padding(
            ...
            child: Text(
              AppLocalizations.of(context)!
                  .translate('profile', 'sharedMediaString'),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  AppLocalizations.of(context)!
                                      .translate('profile', 'viewAllString'),
                                  style: TextStyle(
                                    fontSize: 14.0,
                                    color: whiteColor,
                                  ),
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              AppLocalizations.of(context)!
                  .translate('profile', 'phoneNumberString'),
              style: blackHeadingTextStyle,
            ),
          ),
          Padding(
  ...
  void choiceAction(String choice) {
    if (choice ==
        AppLocalizations.of(context)!.translate('profile', 'reportString')) {
      Fluttertoast.showToast(
        msg: AppLocalizations.of(context)!.translate('profile', 'reportString'),
        backgroundColor: Colors.black,
        textColor: whiteColor,
      );
    } else if (choice ==
        AppLocalizations.of(context)!.translate('profile', 'blockString')) {
      Fluttertoast.showToast(
        msg: AppLocalizations.of(context)!.translate('profile', 'blockString'),
        backgroundColor: Colors.black,
        textColor: whiteColor,
      );
    }
