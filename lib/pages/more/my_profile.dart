  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        titleSpacing: 0.0,
        title: Text(
          AppLocalizations.of(context)!.translate('myProfile', 'profileString'),
        ...
        child: Column(
          ...
          children: [
                          ...
                          children: [
                            Text(
                              AppLocalizations.of(context)!
                                  .translate('myProfile', 'nameString'),
            ...
            Padding(
              ...
              child: Text(
                AppLocalizations.of(context)!
                    .translate('myProfile', 'thisIsNotYourUsernameString'),
                style: greySmallTextStyle,
              ),
            ),
          ],
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context)!
                              .translate('myProfile', 'aboutString'),
                          style: greySmallTextStyle,
                        ),
                        SizedBox(height: 3.0),
                        Padding(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)!
                            .translate('myProfile', 'phoneString'),
                        style: greySmallTextStyle,
                      ),
                      SizedBox(height: 3.0),
                      Text(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)!
                          .translate('myProfile', 'profilePhotoString'),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  AppLocalizations.of(context)!
                                      .translate('myProfile', 'galleryString'),
                                  style: greyNormalTextStyle,
                                  textAlign: TextAlign.center,
                                ),
                              ],
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  AppLocalizations.of(context)!
                                      .translate('myProfile', 'cameraString'),
                                  style: greyNormalTextStyle,
                                  textAlign: TextAlign.center,
                                ),
                              ],
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)!
                            .translate('myProfile', 'enterYourNameString'),
                        style: blackHeadingTextStyle,
                      ),
                      heightSpace,
                      TextField(
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context)!
                                    .translate('myProfile', 'cancelString'),
                                style: TextStyle(
                                  color: primaryColor,
                                  fontSize: 17.0,
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context)!
                                    .translate('myProfile', 'saveString'),
                                style: TextStyle(
                                  color: primaryColor,
                                  fontSize: 17.0,
                                  fontWeight: FontWeight.w500,
