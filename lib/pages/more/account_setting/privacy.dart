  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        titleSpacing: 0.0,
        title: Text(
          AppLocalizations.of(context)!.translate('privacy', 'privacyString'),
        ...
        children: [
          Text(
            AppLocalizations.of(context)!
                .translate('privacy', 'whoCanSeeMyPersonalInfoString'),
            style: primaryColorNormalTextStyle,
          ),
          heightSpace,
          Text(
            AppLocalizations.of(context)!
                .translate('privacy', 'ifYouDontShareLastseenString'),
